...
public class ConsoleOutputHandler {
    ...
    public void showBoard(GameBoard board) {
        String alphabets = generateColAlphabetsString(board);
    ...
    private String generateColAlphabetsString(GameBoard board) {
    ...
    public void pringCommentForUserAction() {
    ...
    public void pringSimpleMessage(String message) {
